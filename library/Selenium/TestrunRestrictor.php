    ...
    public function applyRestrictions(Query $query)
    {
        ...
        foreach ($queries as $query) {
            ...
            foreach ($this->getAuth()->getUser()->getRoles() as $role) {
                ...
                if (($restriction = $role->getRestrictions('selenium/filter/testruns'))) {
                    $roleFilter->add($this->parseRestriction($restriction, 'selenium/filter/testruns'));
                }
