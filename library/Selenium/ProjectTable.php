...
/**
 * Table widget to display a list of Projects
 */
class ProjectTable extends DataTable
{
    ...
    {
        $columns =[];
        foreach ((new Project())->getColumnDefinitions() as $column => $options){
            if(is_array($options)) {
    ...
    protected function renderRow(Model $row)
    {
        ...
        if (Auth::getInstance()->hasPermission('selenium/project/modify')) {
            $url = Url::fromPath('selenium/project/edit', ['id' => $row->id]);
