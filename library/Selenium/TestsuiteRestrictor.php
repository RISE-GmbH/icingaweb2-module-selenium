    ...
    public function applyRestrictions(Query $query)
    {
        ...
        foreach ($queries as $query) {
            ...
            foreach ($this->getAuth()->getUser()->getRoles() as $role) {
                ...
                if (($restriction = $role->getRestrictions('selenium/filter/testsuites'))) {
                    $roleFilter->add($this->parseRestriction($restriction, 'selenium/filter/testsuites'));
                }
