...
class TestrunForm extends CompatForm
{
     ...
     *
     * @return \Icinga\Module\Selenium\Forms\TestrunForm
     */
    ...
    protected function assemble()
    {
        ...
        $columns = (new Testrun())->getColumnDefinitions();
    ...
    public function onSuccess()
    {
        ...
        if ($this->id === null) {
            ...
            $model = Testrun::on(Database::get())->filter(Filter::equal('id', $this->id))->first();
