...
class ProjectForm extends CompatForm
{
     ...
     *
     * @return \Icinga\Module\Selenium\Forms\ProjectForm
     */
    ...
    /**
     * Create a new form instance with the given project id
     *
     * @param $id
     *
     * @return \Icinga\Module\Selenium\Forms\ProjectForm
    ...
    public function getSubmitButtonLabel(): string
    {
        ...
        return $this->id === null ? $this->translate('Create Project') : $this->translate('Update Project');
    }
    protected function assemble()
    {

        $columns = (new Project())->getColumnDefinitions();
        ...
        if ($this->id !== null) {
            ...
            $removeButton = $this->createElement('submit', 'remove', [
                'label'          => $this->translate('Remove Project'),
                'class'          => 'btn-remove',
                'formnovalidate' => true
            ]);
    ...
    public function onSuccess()
    {
        ...
        if ($this->id === null) {
            ...
            $model = Project::on(Database::get())->filter(Filter::equal('id', $this->id))->first();
