...
class ActivityForm extends CompatForm
{
     ...
     *
     * @return \Icinga\Module\Selenium\Forms\ActivityForm
     */
    ...
    /**
     * Create a new form instance with the given testrun id
     *
     * @param $id
     *
     * @return \Icinga\Module\Selenium\Forms\ActivityForm
    ...
    public function getSubmitButtonLabel(): string
    {
        ...
        return $this->id === null ? $this->translate('Create Testrun') : $this->translate('Update Testrun');
    }
    protected function assemble()
    {

        $columns = (new Activity())->getColumnDefinitions();
        ...
        if ($this->id !== null) {
            ...
            $removeButton = $this->createElement('submit', 'remove', [
                'label'          => $this->translate('Remove Testrun'),
                'class'          => 'btn-remove',
                'formnovalidate' => true
            ]);
    ...
    public function onSuccess()
    {
        ...
        if ($this->id === null) {
            ...
            $model = Activity::on(Database::get())->filter(Filter::equal('id', $this->id))->first();
